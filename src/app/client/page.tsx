        ...
        <main className="flex-1 flex bg-[#cdd5f6] bg-color">
          ...
          <section className="flex-1 p-4 flex flex-col items-center gap-6 overflow-y-auto">
            ...
            <section className="w-full px-6">
              ...
              <h3 className="text-2xl italic text-gray-300 flex justify-center">Click job postings that say "Open to applicants" to view potential applicants and click job postings that say "Hired" to view and create milestones for that job: </h3>
